...
button { font: inherit; }
.detail-page { min-height: 100vh; color: #172033; background: #fff; font-size: 14px; }
...
.header-link { display: flex; align-items: center; gap: 7px; color: #596579; font-size: 13px; font-weight: 600; }
.header-link:hover, .review-link:hover, .section-heading button:hover { color: #4f46e5; }
.avatar-button { width: 32px; height: 32px; border-radius: 50%; background: #eee9e1; color: #72543a; font-size: 10px; font-weight: 800; }
.content-shell { max-width: 1280px; margin: auto; padding: 20px 32px 80px; }
.breadcrumbs { display: flex; gap: 8px; align-items: center; color: #4f46e5; font-size: 12px; margin-bottom: 14px; }
...
.eyebrow { display: inline-flex; align-items: center; gap: 5px; margin-bottom: 6px; color: #6558df; font-size: 11px; font-weight: 700; }
.verified-dot { width: 16px; height: 16px; border-radius: 50%; display: grid; place-items: center; background: #6456e5; color: #fff; }
h1 { margin: 0; color: #1a2435; font-size: clamp(21px, 2vw, 27px); line-height: 1.2; letter-spacing: -.035em; }
.property-meta { display: flex; align-items: center; flex-wrap: wrap; gap: 8px; margin-top: 8px; color: #6e788c; font-size: 12px; }
...
.round-action { display: grid; place-items: center; width: 36px; height: 36px; color: #6c7587; border: 1px solid #e2e5eb; border-radius: 50%; }
.round-action:hover, .round-action.active { color: #4f46e5; border-color: #c8c4fa; background: #f7f6ff; }
.main-grid { display: grid; grid-template-columns: minmax(0, 1fr) 355px; gap: 25px; align-items: start; }
...
.gallery-badge { position: absolute; top: 14px; left: 14px; display: inline-flex; align-items: center; gap: 5px; padding: 6px 9px; border-radius: 5px; color: #fff; background: #5a4de5; font-size: 10px; font-weight: 700; box-shadow: 0 4px 12px rgba(24,31,70,.2); }
.gallery-arrow { position: absolute; top: 50%; display: grid; place-items: center; width: 32px; height: 32px; transform: translateY(-50%); border-radius: 50%; color: #4e596d; background: rgba(255,255,255,.95); box-shadow: 0 3px 12px rgba(15,23,42,.13); }
.gallery-arrow:hover { color: #4f46e5; background: #fff; }
.gallery-arrow.previous { left: 12px; }.gallery-arrow.next { right: 12px; }
.photo-count { position: absolute; right: 13px; bottom: 13px; display: flex; align-items: center; gap: 5px; padding: 7px 10px; border-radius: 7px; color: #fff; background: rgba(22,30,48,.62); font-size: 11px; font-weight: 600; backdrop-filter: blur(6px); }
...
.more-photos { position: absolute; inset: 0; display: grid; place-items: center; color: #fff; background: rgba(20,26,40,.47); font-size: 12px; font-weight: 800; }
.detail-tabs { display: flex; gap: 25px; height: 52px; margin-top: 14px; border-bottom: 1px solid #eceef2; }
.detail-tabs button { position: relative; padding: 0 0 3px; color: #7d8798; font-size: 12px; font-weight: 600; }
...
.tab-content { padding-top: 19px; }.intro-section h2, .amenity-section h2, .tab-panel h2 { margin: 0 0 8px; color: #242d3e; font-size: 14px; font-weight: 800; }.intro-section p { max-width: 680px; margin: 0; color: #667286; font-size: 12px; line-height: 1.75; }.read-more { display: inline-flex; gap: 7px; margin-top: 7px; padding: 0; color: #4f46e5; font-size: 11px; font-weight: 700; }.read-more span { font-size: 15px; line-height: 10px; }
.feature-strip { display: grid; grid-template-columns: repeat(5, 1fr); gap: 10px; margin-top: 19px; padding: 15px 10px; border: 1px solid #eff0f4; border-radius: 10px; box-shadow: 0 4px 14px rgba(29,38,62,.03); }.feature-item { display: flex; align-items: center; justify-content: center; gap: 7px; min-width: 0; color: #667286; }.feature-icon { display: grid; place-items: center; width: 27px; height: 27px; flex: 0 0 27px; color: #584fe0; border-radius: 8px; background: #f0efff; }.feature-item span:last-child { display: flex; flex-direction: column; gap: 2px; min-width: 0; }.feature-item strong { color: #394359; font-size: 11px; white-space: nowrap; }.feature-item small { overflow: hidden; color: #97a0af; font-size: 9px; text-overflow: ellipsis; white-space: nowrap; }
.amenity-section { margin-top: 23px; padding-top: 17px; border-top: 1px solid #f0f1f4; }.section-heading { display: flex; align-items: center; justify-content: space-between; }.section-heading button { color: #5549dc; font-size: 11px; font-weight: 700; }.amenity-grid { display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 12px 18px; margin-top: 12px; }.amenity-grid.expanded { grid-template-columns: repeat(3, minmax(0, 1fr)); max-width: 700px; }.amenity-item { display: flex; align-items: center; gap: 9px; color: #6a7487; font-size: 12px; }.amenity-item .ui-icon { color: #6860dd; }
.booking-column { position: sticky; top: 18px; }.booking-card, .host-card { border: 1px solid #e8eaf0; border-radius: 12px; background: #fff; box-shadow: 0 6px 23px rgba(26,35,59,.08); }.booking-card { position: relative; padding: 18px; }.price-row { display: flex; align-items: baseline; justify-content: space-between; gap: 10px; }.price-row strong { color: #1c2536; font-size: 21px; letter-spacing: -.03em; }.price-row > div > span { margin-left: 3px; color: #7f8998; font-size: 11px; }.instant-label { display: inline-flex; align-items: center; gap: 3px; color: #4f46e5; font-size: 10px; font-weight: 700; }.small-note { margin: 4px 0 15px; color: #9aa2b0; font-size: 10px; }.booking-fields { display: grid; grid-template-columns: 1fr 1fr; gap: 8px; }.date-field, .guest-field { position: relative; display: flex; flex-direction: column; gap: 4px; min-height: 51px; padding: 9px 28px 8px 10px; text-align: left; color: #374054; border: 1px solid #e4e6ec; border-radius: 7px; background: #fff; }.date-field span, .guest-field small { color: #929aaa; font-size: 9px; }.date-field strong, .guest-field strong { font-size: 10px; font-weight: 700; }.date-field .ui-icon, .guest-field .ui-icon { position: absolute; top: 19px; right: 9px; color: #747f92; }.guest-field { grid-column: 1 / -1; flex-direction: row; align-items: center; justify-content: space-between; padding: 8px 10px; }.guest-field span { display: flex; flex-direction: column; gap: 3px; }.guest-field .ui-icon { position: static; }.guest-popover { position: absolute; z-index: 2; right: 18px; left: 18px; display: flex; align-items: center; justify-content: space-between; padding: 11px 12px; color: #555f72; border: 1px solid #e2e5ec; border-radius: 8px; background: #fff; box-shadow: 0 9px 25px rgba(22,33,59,.15); font-size: 11px; }.guest-counter { display: flex; align-items: center; gap: 12px; }.guest-counter button { display: grid; place-items: center; width: 22px; height: 22px; color: #5147d7; border: 1px solid #d9daf3; border-radius: 50%; background: #fafaff; cursor: pointer; }.guest-counter button:disabled { color: #bdc2cb; cursor: not-allowed; }.guest-counter strong { color: #222c3c; font-size: 12px; }
.primary-button, .secondary-button { width: 100%; min-height: 36px; border-radius: 6px; cursor: pointer; font-size: 11px; font-weight: 700; }.primary-button { margin-top: 14px; color: #fff; border: 1px solid #5549dc; background: #594dde; box-shadow: 0 5px 12px rgba(83,73,220,.2); }.primary-button:hover { background: #4e43ce; }.secondary-button { display: flex; align-items: center; justify-content: center; gap: 6px; margin-top: 7px; color: #5549dc; border: 1px solid #bdb9f4; background: #fff; }.secondary-button:hover { background: #f8f7ff; }.booking-disclaimer { margin: 12px 0 16px; color: #9ba3b0; text-align: center; font-size: 9px; line-height: 1.45; }.trust-list { padding-top: 13px; border-top: 1px solid #eff0f3; }.trust-item { display: flex; align-items: flex-start; gap: 9px; margin-top: 12px; }.trust-item:first-child { margin-top: 0; }.trust-icon { display: grid; place-items: center; width: 25px; height: 25px; flex: 0 0 25px; color: #6259dd; border-radius: 50%; background: #f0efff; }.trust-item > span:last-child { display: flex; flex-direction: column; gap: 3px; }.trust-item strong { color: #4d576a; font-size: 10px; }.trust-item small { color: #9ba3b0; font-size: 9px; }
.host-card { margin-top: 12px; padding: 14px 15px; }.host-header { display: flex; align-items: center; gap: 9px; }.host-header img { width: 38px; height: 38px; object-fit: cover; object-position: 58% 45%; border: 2px solid #eeeaff; border-radius: 50%; }.host-header > div { display: flex; flex: 1; flex-direction: column; gap: 4px; }.host-header span { color: #303a4c; font-size: 11px; font-weight: 800; }.host-header small { color: #8a94a3; font-size: 9px; }.host-stars { color: #f1ab24; }.host-header > .ui-icon { color: #99a1af; }.host-card > p { margin: 11px 0 13px 47px; color: #a0a8b4; font-size: 9px; }.host-stats { display: grid; grid-template-columns: repeat(3, 1fr); padding: 11px 0; border-top: 1px solid #f0f1f3; border-bottom: 1px solid #f0f1f3; text-align: center; }.host-stats span { display: flex; flex-direction: column; gap: 3px; border-right: 1px solid #f0f1f3; }.host-stats span:last-child { border-right: 0; }.host-stats strong { color: #4b5567; font-size: 10px; }.host-stats small { color: #9da5b1; font-size: 8px; }.host-card > button { width: 100%; margin-top: 11px; padding: 8px; color: #5549dc; border: 1px solid #c7c3f6; border-radius: 6px; font-size: 10px; font-weight: 700; }.host-card > button:hover { background: #f8f7ff; }
.tab-panel { min-height: 180px; }.review-summary { display: flex; align-items: center; gap: 14px; padding: 15px; border-radius: 10px; background: #f8f7ff; }.big-rating { color: #302b8c; font-size: 28px; font-weight: 800; }.review-summary > span:last-child { display: flex; flex-direction: column; gap: 3px; }.stars, .review-top span { color: #f3a925; letter-spacing: 2px; }.review-summary small { color: #8490a1; font-size: 11px; }.review-list { display: grid; gap: 10px; margin-top: 15px; }.review-card { padding: 13px; border: 1px solid #eceef3; border-radius: 9px; }.review-top { display: flex; justify-content: space-between; }.review-top strong { color: #394255; font-size: 11px; }.review-top span { font-size: 10px; }.review-card p { margin: 7px 0; color: #707b8d; font-size: 11px; line-height: 1.5; }.review-card small { color: #a0a7b2; font-size: 9px; }.rules-list { display: grid; gap: 10px; }.rules-list p { display: flex; align-items: center; gap: 8px; margin: 0; color: #6b7688; font-size: 12px; }.rules-list .ui-icon { color: #5b51dc; }
.toast-message { position: fixed; z-index: 20; right: 22px; bottom: 22px; display: flex; align-items: center; gap: 8px; padding: 11px 15px; color: #fff; border-radius: 8px; background: #253047; box-shadow: 0 10px 28px rgba(15,23,42,.2); font-size: 12px; }.toast-message .ui-icon { color: #a8f0cc; }
.modal-backdrop { position: fixed; z-index: 30; inset: 0; display: grid; place-items: center; padding: 25px; background: rgba(13,19,33,.65); backdrop-filter: blur(4px); }.gallery-modal { width: min(860px, 100%); max-height: min(700px, 90vh); overflow: auto; padding: 20px; border-radius: 15px; background: #fff; }.modal-header { display: flex; align-items: center; justify-content: space-between; margin-bottom: 15px; }.modal-header h2 { margin: 0; font-size: 17px; }.modal-header button { width: 30px; height: 30px; color: #657084; border: 1px solid #e5e7ec; border-radius: 50%; font-size: 22px; line-height: 1; }.modal-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 10px; }.modal-grid button { min-height: 160px; overflow: hidden; padding: 0; border: 0; border-radius: 8px; background: #f1f2f4; cursor: pointer; }.modal-grid img { display: block; width: 100%; height: 100%; object-fit: cover; }
.lower-content { margin-top: 46px; }
.lower-grid { display: grid; grid-template-columns: minmax(0, 1fr) 355px; gap: 25px; align-items: start; }
...
.lower-section h2, .location-card h2, .similar-heading h2 { margin: 0; color: #242d3e; font-size: 16px; letter-spacing: -.02em; }
.section-caption { color: #a0a8b5; font-size: 10px; }
.detailed-amenities { display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); gap: 17px 12px; margin-top: 20px; }
.detailed-amenity { display: flex; align-items: center; gap: 8px; color: #657084; font-size: 11px; }
.detailed-amenity-icon { display: grid; place-items: center; width: 27px; height: 27px; flex: 0 0 27px; color: #5b50d8; border-radius: 8px; background: #f3f2ff; }
.description-points { display: grid; gap: 10px; margin-top: 17px; }
.description-points p { display: flex; align-items: flex-start; gap: 9px; margin: 0; color: #687489; font-size: 11px; line-height: 1.45; }
.description-points .ui-icon { flex: 0 0 auto; margin-top: 1px; color: #5c55d9; }
.description-more { display: inline-flex; align-items: center; gap: 4px; margin-top: 11px; padding: 0; color: #5549dc; border: 0; background: transparent; cursor: pointer; font-size: 10px; font-weight: 700; }
.reviews-detail { padding-bottom: 0; }
.reviews-layout { display: grid; grid-template-columns: 100px 215px minmax(0, 1fr); gap: 14px; margin-top: 17px; }
...
.review-score-box strong { color: #252b79; font-size: 27px; line-height: 1; }.review-score-box > span { margin-top: 3px; color: #8f98a7; font-size: 10px; }.score-stars { margin-top: 7px; color: #f6b014; font-size: 13px; letter-spacing: 1px; }.review-score-box small { margin-top: 3px; color: #9ca5b3; font-size: 9px; }
.write-review { min-height: 30px; color: #5549dc; border: 1px solid #bebaf3; border-radius: 6px; background: #fff; cursor: pointer; font-size: 10px; font-weight: 700; }.write-review:hover { background: #f8f7ff; }
.rating-breakdown { display: flex; flex-direction: column; justify-content: center; gap: 11px; padding-right: 15px; border-right: 1px solid #ebedf1; }.rating-row { display: grid; grid-template-columns: 32px minmax(0, 1fr) 19px; align-items: center; gap: 7px; color: #535d70; font-size: 10px; }.rating-row > span { display: flex; align-items: center; gap: 3px; white-space: nowrap; }.rating-row > span .ui-icon { color: #f3ac1c; }.rating-row strong { color: #86909f; text-align: right; font-size: 9px; }.rating-track { height: 5px; overflow: hidden; border-radius: 99px; background: #edf0f4; }.rating-track i { display: block; height: 100%; border-radius: inherit; background: #5549df; }
.review-feed { display: grid; gap: 11px; padding-left: 1px; }.feed-review { display: grid; grid-template-columns: 31px minmax(0, 1fr); gap: 8px; }.feed-review img { width: 31px; height: 31px; object-fit: cover; border-radius: 50%; }.feed-review-heading { display: flex; align-items: baseline; justify-content: space-between; gap: 8px; }.feed-review-heading strong { color: #3a4558; font-size: 10px; }.feed-review-heading span { color: #9aa2af; font-size: 8px; }.feed-review-stars { margin-top: 2px; color: #f4ae1c; font-size: 9px; letter-spacing: 1px; }.feed-review p { margin: 3px 0 0; color: #697488; font-size: 9px; line-height: 1.35; }.all-reviews { justify-self: start; margin: 2px 0 0 39px; padding: 0; color: #5549dc; border: 0; background: transparent; cursor: pointer; font-size: 10px; font-weight: 700; }.all-reviews span, .nearby-more span { margin-left: 4px; font-size: 13px; }
.location-card { padding: 17px; border: 1px solid #e7eaf0; border-radius: 12px; box-shadow: 0 6px 23px rgba(26,35,59,.06); }.location-card h2 { font-size: 13px; }.map-canvas { position: relative; height: 138px; overflow: hidden; margin: 11px 0 12px; border-radius: 8px; background: #e8f1e9; background-image: linear-gradient(35deg, transparent 44%, rgba(255,255,255,.8) 45%, rgba(255,255,255,.8) 48%, transparent 49%), linear-gradient(145deg, transparent 46%, rgba(255,255,255,.75) 47%, rgba(255,255,255,.75) 50%, transparent 51%), radial-gradient(circle at 23% 60%, #bddbbb 0 10%, transparent 10.5%), radial-gradient(circle at 79% 22%, #c4dfbf 0 15%, transparent 15.5%); }.map-canvas::before { position: absolute; inset: -20px; content: ''; opacity: .55; background: repeating-linear-gradient(27deg, transparent 0 24px, rgba(255,255,255,.7) 25px 27px, transparent 28px 52px), repeating-linear-gradient(112deg, transparent 0 36px, rgba(255,255,255,.55) 37px 39px, transparent 40px 65px); transform: rotate(-8deg); }.map-road { position: absolute; z-index: 1; height: 5px; border-radius: 99px; background: rgba(255,255,255,.95); box-shadow: 0 1px 1px rgba(102,132,107,.16); transform-origin: center; }.road-one { top: 55px; left: -18px; width: 210px; transform: rotate(12deg); }.road-two { top: 93px; left: 88px; width: 240px; transform: rotate(-25deg); }.road-three { top: 29px; right: -32px; width: 230px; transform: rotate(-42deg); }.road-four { top: 108px; left: -35px; width: 390px; transform: rotate(3deg); }.map-label { position: absolute; z-index: 2; color: #7f9a87; font-size: 8px; font-weight: 600; }.label-one { top: 26px; left: 30px; }.label-two { right: 13px; bottom: 25px; }.label-three { top: 88px; left: 35px; }.map-marker { position: absolute; z-index: 3; top: 51px; left: 50%; display: grid; place-items: center; width: 30px; height: 30px; color: #fff; border: 3px solid #fff; border-radius: 50% 50% 50% 5px; background: #6356e2; box-shadow: 0 4px 10px rgba(55,52,159,.26); transform: translate(-50%, -50%) rotate(-45deg); }.map-marker .ui-icon { transform: rotate(45deg); }.map-point { position: absolute; z-index: 2; width: 6px; height: 6px; border: 2px solid #fff; border-radius: 50%; background: #65b5d2; }.point-one { top: 66px; left: 23%; }.point-two { right: 17%; bottom: 23%; background: #eba949; }.point-three { top: 24%; right: 31%; background: #e78378; }
.location-card h3 { margin: 0; color: #344055; font-size: 11px; }.location-note { margin: 4px 0 12px; color: #8d97a5; font-size: 9px; }.nearby-list { display: grid; gap: 8px; }.nearby-list > div { display: flex; align-items: center; justify-content: space-between; gap: 8px; color: #647085; font-size: 9px; }.nearby-list span { display: flex; align-items: center; gap: 6px; }.nearby-list i { width: 6px; height: 6px; border: 1px solid #9099a9; border-radius: 50%; }.nearby-list small { color: #7b8596; white-space: nowrap; }.nearby-more { margin-top: 14px; padding: 0; color: #5549dc; border: 0; background: transparent; cursor: pointer; font-size: 9px; font-weight: 700; }
.similar-section { position: relative; margin-top: 35px; padding-top: 23px; border-top: 1px solid #edf0f4; }.similar-heading { display: flex; align-items: center; justify-content: space-between; margin-bottom: 16px; }.similar-heading h2 { font-size: 16px; }.similar-heading button { padding: 0; color: #5549dc; border: 0; background: transparent; cursor: pointer; font-size: 10px; font-weight: 700; }.similar-list { display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); gap: 15px; }.similar-card { overflow: hidden; border: 1px solid #e7eaf0; border-radius: 9px; background: #fff; cursor: pointer; transition: transform .15s, box-shadow .15s; }.similar-card:hover { box-shadow: 0 8px 20px rgba(36,44,73,.11); transform: translateY(-2px); }.similar-image { position: relative; height: 118px; overflow: hidden; background: #eee; }.similar-image img { display: block; width: 100%; height: 100%; object-fit: cover; }.similar-image button { position: absolute; top: 8px; right: 8px; display: grid; place-items: center; width: 24px; height: 24px; color: #6b7586; border: 1px solid #e4e7ec; border-radius: 50%; background: rgba(255,255,255,.94); cursor: pointer; }.similar-image button:hover { color: #4f46e5; }.similar-body { padding: 10px 9px 11px; }.similar-body h3 { overflow: hidden; margin: 0; color: #3e485b; font-size: 10px; text-overflow: ellipsis; white-space: nowrap; }.similar-body p { overflow: hidden; margin: 4px 0 11px; color: #9aa2af; font-size: 9px; text-overflow: ellipsis; white-space: nowrap; }.similar-bottom { display: flex; align-items: center; justify-content: space-between; gap: 5px; }.similar-bottom strong { color: #4f46db; font-size: 10px; }.similar-bottom span { display: inline-flex; align-items: center; gap: 3px; color: #8b95a2; font-size: 9px; }.similar-bottom span .ui-icon { color: #f2aa16; }.similar-bottom small { color: #a3aab5; font-size: 8px; }.similar-arrow { position: absolute; top: 49%; display: grid; place-items: center; width: 31px; height: 31px; color: #5c55db; border: 1px solid #e1e3f5; border-radius: 50%; background: #fff; box-shadow: 0 3px 10px rgba(38,43,80,.1); cursor: pointer; }.similar-arrow.left { left: -15px; }.similar-arrow.right { right: -15px; }.similar-arrow:hover { background: #f7f6ff; }
.detail-footer { display: grid; grid-template-columns: 1.6fr repeat(4, 1fr); gap: 35px; margin-top: 53px; padding: 27px 12px 22px; border-top: 1px solid #edf0f4; }.footer-brand .brand { padding: 0; }.footer-brand p { max-width: 205px; margin: 13px 0; color: #8b95a5; font-size: 9px; line-height: 1.65; }.social-links { display: flex; gap: 8px; }.social-links button { display: grid; place-items: center; width: 21px; height: 21px; color: #667184; border: 0; border-radius: 50%; background: #f1f3f7; cursor: pointer; font-size: 11px; font-weight: 800; }.footer-column { display: flex; flex-direction: column; align-items: flex-start; gap: 10px; }.footer-column h3 { margin: 3px 0 3px; color: #354054; font-size: 10px; }.footer-column button { padding: 0; color: #8b95a4; border: 0; background: transparent; cursor: pointer; text-align: left; font-size: 9px; line-height: 1.45; }.footer-column button:hover { color: #5549dc; }.footer-bottom { display: flex; align-items: center; justify-content: center; min-height: 28px; color: #9da5b2; border-top: 1px solid #f1f2f5; font-size: 8px; }.footer-bottom button { position: absolute; right: 23px; display: grid; place-items: center; width: 25px; height: 25px; color: #5f55df; border: 0; border-radius: 50%; background: #eae9ff; cursor: pointer; font-size: 16px; }
